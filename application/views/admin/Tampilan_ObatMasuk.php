...
<h1 style="font-weight:bold">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i> Beranda > Obat Masuk</a></li>
            </ol>
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Form Obat Masuk<br>
          ...
          <div class="modal-footer">
            ...
            <input type="button" class="btn btn-success save" value="Simpan" onclick="postTransaksiObatMasuk();"></button>
          </div>
          </form>
        </div>
